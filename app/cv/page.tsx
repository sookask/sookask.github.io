  ...
  return (
    <div className="container px-4 md:px-6 py-12">
      <div className="flex flex-col gap-8 max-w-4xl mx-auto">
        ...
        {/* Temporarily commented out Conferences section
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Card>
            <CardHeader>
              <h2 className="text-2xl font-bold">🎤 Conferences & Events</h2>
            </CardHeader>
            <CardContent className="grid gap-6">
              <div>
                <div className="flex justify-between">
                  <h3 className="font-semibold">WWDC 2025</h3>
                  <span className="text-muted-foreground">June 2025</span>
                </div>
                <p className="text-muted-foreground">Apple Worldwide Developers Conference</p>
                <ul className="list-disc list-inside mt-2 space-y-1">
                  <li>Attended as a Swift Student Challenge winner</li>
                  <li>Participated in technical sessions and labs</li>
                  <li>Networked with Apple engineers and fellow developers</li>
                </ul>
              </div>
            </CardContent>
          </Card>
