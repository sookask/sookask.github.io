        ...
        >
          ...
          <section className="space-y-4 mb-8">
            ...
            <p className="text-lg mb-2">
              Kui Maci püsivara vajab taastamist või elustamist, võib Apple Siliconi või T2-kiviga seade muutuda laibaks. Seda juhtub harva — kui DFU midagi korda teeb, siis on see üks ilus päev.
            </p>
